...
clean.data = function(input_file){
  ...
  cols.num = c("UPC", "Store Nbr","Building Postal Code","WM Date" , "OH Qty" , "POS Sales" ,"POS Qty" )
  ...
  combine_arrivals_cleaned = rbind(since_first_ship, arrival_first_season_day)
  
  return(combine_arrivals_cleaned)
}
